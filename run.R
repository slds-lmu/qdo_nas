...
packages = c("R6", "checkmate", "bbotk", "mlr3mbo", "reticulate", "mlr3misc", "data.table", "mlr3", "mlr3learners")
...
jobs = findJobs()
resources.serial.default = list(memory = 16384L, walltime = 1000L, ntasks = 1L, ncpus = 1L, nodes = 1L)
