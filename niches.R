...
nb201_cifar10_small_n2 = NicheBoundaries$new("niche2", niche_boundaries = list(latency = c(0.01596731888620477, Inf)))
...
nb201_cifar10_medium_n2 = NicheBoundaries$new("niche2", niche_boundaries = list(latency = c(0.00919228, 0.01138714)))
nb201_cifar10_medium_n3 = NicheBoundaries$new("niche3", niche_boundaries = list(latency = c(0.01138714, 0.01232998)))
nb201_cifar10_medium_n4 = NicheBoundaries$new("niche4", niche_boundaries = list(latency = c(0.01232998, 0.01475572)))
nb201_cifar10_medium_n5 = NicheBoundaries$new("niche5", niche_boundaries = list(latency = c(0.01475572, Inf)))
...
nb201_cifar10_large_n2 = NicheBoundaries$new("niche2", niche_boundaries = list(latency = c(0.00919228, 0.00957457)))
nb201_cifar10_large_n3 = NicheBoundaries$new("niche3", niche_boundaries = list(latency = c(0.00957457, 0.01138714)))
nb201_cifar10_large_n4 = NicheBoundaries$new("niche4", niche_boundaries = list(latency = c(0.01138714, 0.01232998)))
nb201_cifar10_large_n5 = NicheBoundaries$new("niche5", niche_boundaries = list(latency = c(0.01232998, 0.01327515)))
nb201_cifar10_large_n6 = NicheBoundaries$new("niche6", niche_boundaries = list(latency = c(0.01327515, 0.01475572)))
nb201_cifar10_large_n7 = NicheBoundaries$new("niche7", niche_boundaries = list(latency = c(0.01475572, 0.01534633)))
nb201_cifar10_large_n8 = NicheBoundaries$new("niche8", niche_boundaries = list(latency = c(0.01534633, 0.01596732)))
nb201_cifar10_large_n9 = NicheBoundaries$new("niche9", niche_boundaries = list(latency = c(0.01596732, 0.01768237)))
nb201_cifar10_large_n10 = NicheBoundaries$new("niche10", niche_boundaries = list(latency = c(0.01768237, Inf)))
...
nb201_cifar100_small_n2 = NicheBoundaries$new("niche2", niche_boundaries = list(latency = c(0.015000444871407967, Inf)))
...
nb201_cifar100_medium_n2 = NicheBoundaries$new("niche2", niche_boundaries = list(latency = c(0.00856115, 0.01030767)))
nb201_cifar100_medium_n3 = NicheBoundaries$new("niche3", niche_boundaries = list(latency = c(0.01030767, 0.01143533)))
nb201_cifar100_medium_n4 = NicheBoundaries$new("niche4", niche_boundaries = list(latency = c(0.01143533, 0.01363741)))
nb201_cifar100_medium_n5 = NicheBoundaries$new("niche5", niche_boundaries = list(latency = c(0.01363741, Inf)))
...
nb201_cifar100_large_n2 = NicheBoundaries$new("niche2", niche_boundaries = list(latency = c(0.00856115, 0.00893427)))
nb201_cifar100_large_n3 = NicheBoundaries$new("niche3", niche_boundaries = list(latency = c(0.00893427, 0.01030767)))
nb201_cifar100_large_n4 = NicheBoundaries$new("niche4", niche_boundaries = list(latency = c(0.01030767, 0.01143533)))
nb201_cifar100_large_n5 = NicheBoundaries$new("niche5", niche_boundaries = list(latency = c(0.01143533, 0.01250159)))
nb201_cifar100_large_n6 = NicheBoundaries$new("niche6", niche_boundaries = list(latency = c(0.01250159, 0.01363741)))
nb201_cifar100_large_n7 = NicheBoundaries$new("niche7", niche_boundaries = list(latency = c(0.01363741, 0.01429903)))
nb201_cifar100_large_n8 = NicheBoundaries$new("niche8", niche_boundaries = list(latency = c(0.01429903, 0.01500044)))
nb201_cifar100_large_n9 = NicheBoundaries$new("niche9", niche_boundaries = list(latency = c(0.01500044, 0.01660615)))
nb201_cifar100_large_n10 = NicheBoundaries$new("niche10", niche_boundaries = list(latency = c(0.01660615, Inf)))
...
nb201_imagenet_small_n2 = NicheBoundaries$new("niche2", niche_boundaries = list(latency = c(0.014301609992980958, Inf)))
...
nb201_imagenet_medium_n2 = NicheBoundaries$new("niche2", niche_boundaries = list(latency = c(0.00767465, 0.0094483)))
nb201_imagenet_medium_n3 = NicheBoundaries$new("niche3", niche_boundaries = list(latency = c(0.0094483, 0.01054566)))
nb201_imagenet_medium_n4 = NicheBoundaries$new("niche4", niche_boundaries = list(latency = c(0.01054566, 0.01271056)))
nb201_imagenet_medium_n5 = NicheBoundaries$new("niche5", niche_boundaries = list(latency = c(0.01271056, Inf)))
...
nb201_imagenet_large_n2 = NicheBoundaries$new("niche2", niche_boundaries = list(latency = c(0.00767465, 0.00826192)))
nb201_imagenet_large_n3 = NicheBoundaries$new("niche3", niche_boundaries = list(latency = c(0.00826192, 0.0094483)))
nb201_imagenet_large_n4 = NicheBoundaries$new("niche4", niche_boundaries = list(latency = c(0.0094483, 0.01054566)))
nb201_imagenet_large_n5 = NicheBoundaries$new("niche5", niche_boundaries = list(latency = c(0.01054566, 0.01173623)))
nb201_imagenet_large_n6 = NicheBoundaries$new("niche6", niche_boundaries = list(latency = c(0.01173623, 0.01271056)))
nb201_imagenet_large_n7 = NicheBoundaries$new("niche7", niche_boundaries = list(latency = c(0.01271056, 0.01352221)))
nb201_imagenet_large_n8 = NicheBoundaries$new("niche8", niche_boundaries = list(latency = c(0.01352221, 0.01430161)))
nb201_imagenet_large_n9 = NicheBoundaries$new("niche9", niche_boundaries = list(latency = c(0.01430161, 0.01595311)))
nb201_imagenet_large_n10 = NicheBoundaries$new("niche10", niche_boundaries = list(latency = c(0.01595311, Inf)))
